...
import com.astr.astraicodemother.mapper.UserMapper;
...
import static com.astr.astraicodemother.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        if (!saveResult) {
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "连接失败，数据库错误");
        }
        return user.getId();
    }
